...
metadata_folder_path = "G:/.shortcut-targets-by-id/1kOpNriLPL3kgZ-DM8TK4O3Bw06XKmk6M/Research/Operations/RnD Transfer/Fluent 1080/RNA Prep Data/Backdilution metadata log/test/"
plot_file_path = "G:/.shortcut-targets-by-id/1kOpNriLPL3kgZ-DM8TK4O3Bw06XKmk6M/Research/Operations/RnD Transfer/Fluent 1080/RNA Prep Data/Data visualization outputs/test/"
...
plt.axhline(y=norm_conc_1, color='red', linestyle='--', linewidth=2, xmin=0,xmax=1.0, label='Backdilution normalization target')
...
if source_plate_count > 1:
    plt.axhline(y=norm_conc_2, color='red', linestyle='--', xmin=0,xmax=1.0)
...
if source_plate_count > 2:
    plt.axhline(y=norm_conc_3, color='red', linestyle='--', xmin=0,xmax=1.0)
...
if source_plate_count > 3:
    plt.axhline(y=norm_conc_4, color='red', linestyle='--', xmin=0,xmax=1.0)
