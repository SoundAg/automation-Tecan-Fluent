# The following code was rewritten from the OD660_Quant_RNAP_python_script_LOCAL.py script.
# To run: cd C:/Users/Max/Desktop/RNAP backdilution testing/
# python QuantIT_RNAP_python_script_LOCAL.py
...
for loop_count, excel_filepath in enumerate(only_measurement_filepaths, start=1):
    ...
    if loop_count == 1:
        ...
        backdilution_volume_list_1 = [round(((rna_transfer_volume * (conc / normalization_concentration)) - rna_transfer_volume), 1) if (conc / normalization_concentration) > 1.0 else 0.0 for conc in calculated_rna_conc_list_1]
    ...
    if loop_count == 2: 
        ...
        backdilution_volume_list_2 = [round(((rna_transfer_volume * (conc / normalization_concentration)) - rna_transfer_volume), 1) if (conc / normalization_concentration) > 1.0 else 0.0 for conc in calculated_rna_conc_list_2]
    ...
    if loop_count == 3: 
        ...
        backdilution_volume_list_3 = [round(((rna_transfer_volume * (conc / normalization_concentration)) - rna_transfer_volume), 1) if (conc / normalization_concentration) > 1.0 else 0.0 for conc in calculated_rna_conc_list_3]
    ...
    if loop_count == 4: 
        ...
        backdilution_volume_list_4 = [round(((rna_transfer_volume * (conc / normalization_concentration)) - rna_transfer_volume), 1) if (conc / normalization_concentration) > 1.0 else 0.0 for conc in calculated_rna_conc_list_4]
