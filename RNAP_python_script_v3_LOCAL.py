# To run: cd C:/Users/Max/Desktop/RNAP backdilution testing/ then python RNAP_python_script_v3_LOCAL.py
...
for filename in os.listdir(folder_path):
    ...
    if filename.endswith(".csv"):
        file_dates_modified.update({file_path : date_modified})
...
recent_run_filepaths = list(files_sorted_by_modification_time.keys())[:source_plate_count]
...
# Adjust these values as needed, listed in order from A12-H12
...
for csv_file in recent_run_filepaths:
    ...
    # Change elution volumes for subsequent backdilution volume calculation math, per plate.
    if loop_count == 1:
    ...
    # Change 76 to some other number as needed. This pulls just the filename from the filepath in recent_run_filepaths.
    #filename = recent_run_filepaths[loop_count-1][76:]
    filename = recent_run_filepaths[loop_count-1][47:]
